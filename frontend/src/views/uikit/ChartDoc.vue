...
function setColorOptions() {
    ...
    lineOptions.value = {
        ...
        scales: {
            x: { grid: { display: false }, ticks: { color: textColorSecondary } },
            y: { grid: { color: '#f1f5f9' }, border: { display: false }, ticks: { color: textColorSecondary } }
        }
    };
...
<template>
    <div class="dashboard-grid">
        <div class="card chart-card">
            ...
            <Chart type="line" :data="lineData" :options="lineOptions" class="chart-container" />
        </div>
        ...
        <div class="card chart-card center-chart">
            ...
            <Chart type="pie" :data="pieData" :options="pieOptions" class="pie-container" />
        </div>

        <div class="card chart-card center-chart">
            <div class="font-semibold text-xl mb-4">Doughnut</div>
            <Chart type="doughnut" :data="pieData" :options="pieOptions" class="pie-container" />
        </div>

        <div class="card chart-card center-chart">
            <div class="font-semibold text-xl mb-4">Polar Area</div>
            <Chart type="polarArea" :data="polarData" :options="polarOptions" class="pie-container" />
        </div>
