      ...
      <Card class="card">
        ...
        <template #content>
          <ul class="status-list">
            ...
            <li><strong>Ingestion:</strong> {{ status.ingestion }}</li>
      ...
      <Card class="card">
        ...
        <template #content>
          <ul class="metrics-list">
            <li><strong>Total Records:</strong> {{ metrics.totalRecords }}</li>
            <li><strong>Active Alerts:</strong> {{ metrics.activeAlerts }}</li>
            <li><strong>Last Ingest:</strong> {{ metrics.lastIngest }}</li>
          </ul>
        </template>
      </Card>
    </div>
